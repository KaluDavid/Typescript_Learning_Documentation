...
// But it’s common in TypeScript to see a third comment style: documentation comments. A documentation comment is denoted with the first line
/** and a final line */
...
// This is mainly the use of @param and @return for documenting parameters and return statements in functions

/*
I learned functions
under it I covered few topics such as;
